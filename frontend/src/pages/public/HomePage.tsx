      ...
      <section className='hero'>
        <div className='container hero-grid'>
          ...
          <div className='hero-visual'>
            <div className='print-sheet sheet-one'>BROCHURE</div>
            <div className='print-sheet sheet-two'>STICKER</div>
            <div className='print-sheet sheet-three'>BANNER</div>
          </div>
        </div>
      </section>
        ...
        <div className='container'>
          ...
          <div className='review-grid'>
            {showReviewsSkeleton
              ...
              : (reviews.data?.data ?? []).slice(0, 3).map((r) => (
                  <blockquote key={r.id}>
